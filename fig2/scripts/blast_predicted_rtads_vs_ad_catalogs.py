...
TAD_FASTA = INPUT_FASTA_DIR / "pred_tads_frags.fasta"
DATASETS = [
    {"name": "soto", "fasta": INPUT_FASTA_DIR / "soto_ADs_filtered.fasta"},
    {"name": "kothaHC", "fasta": INPUT_FASTA_DIR / "kotha_staller_high_conf.fasta"},
    {"name": "gsl", "fasta": INPUT_FASTA_DIR / "gsl_kotha_staller.fasta"},
    {"name": "staller2022", "fasta": INPUT_FASTA_DIR / "staller2022_mol_cell.fasta"},
]
...
def run_blast(dataset_name, db_prefix):
    out_tsv = OUTPUT_BLAST_DIR / f"blast_tads_vs_{dataset_name}.tsv"
    cmd = [
